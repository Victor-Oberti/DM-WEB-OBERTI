...
- insérer une chaine de caractère dans la zone de texte et appuyer sur "rechercher" 
- cliquer sur les markers pour obtenir le nom de la ville 
...
## ajout et précision 
- si aucune ville n'est concerné par votre recherche rien ne s'affiche 
...
- j'ai seulement rajouter la superficie de la commune, je n'ai pas pu implémenter d'autre fonctionnalités. 
